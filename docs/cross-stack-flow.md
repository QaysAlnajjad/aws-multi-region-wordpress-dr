...
|   • provided_ssl_certificate_arn            |
│  OUTPUTS:                                   │
│   • media_distribution_arn ─────────────────┼─────▶ used by primary/s3, dr/s3
│   • media_distribution_domain ──────────────┼─────▶ used by primary/ecs, dr/ecs
│   • media_distribution_id ──────────────────┼─────▶ used by primary/ecs, dr/ecs
└─────────────────────────────────────────────┘
┌─────────────────────────────────────────────┐
│                 primary/ecs                 │
|  INPUTS:                                    |
